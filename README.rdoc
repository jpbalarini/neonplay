...
== List songs
curl --header "admin_token: ThisIsNeonPlayToken" http://localhost:3000/songs
curl --header "bar_token: 8093c64331ab2486" http://localhost:3000/songs

== Songs on sale
curl --header "admin_token: ThisIsNeonPlayToken" http://localhost:3000/songs/on_sale
curl --header "bar_token: 8093c64331ab2486" http://localhost:3000/songs/on_sale
...
curl --header "bar_token: 8093c64331ab2486" http://localhost:3000/bars/2/jukebox